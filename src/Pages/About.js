                      ...
                      <div className="col-lg-8">
                        ...
                        <div className="CEO_About_Para1">
                          <p className="size_16 line-28 text_black_dark">
                            ...
                            family of people coming together to help one another
                      ...
                      <div className="About_Fountaion_Wrapper">
                        ...
                        <div>
                          <p className="size_24 line-40 letter_0_5 text_black_dark">
                            ...
                            the availability of quality and secured employment,
                            especially to fresh graduates, and assist till they
                            reach the peak of their career, hence enriching the
                            quality of people's life. To Terafort, the welfare
                            of the people being boosted and secured is of utmost
                      ...
                      <Col lg={4}>
                        <div className="d-md-flex About_Values_Main_Container">
                          ...
                          <div className="col-lg-6 d-flex justify-content-center">
                            <img src={about_values_horizontal_line} alt=".." />
                          </div>
                        </div>
                      </Col>
                      <Col lg={8}>
                        <div className="col-lg-9 About_Values_text_Container">
                          <p className="size_16 line-28 letter_0_5 text_white">
                            a two to three line text with a brief summary of all
                            of our values combined, most importantly it must be
                            a single sentence
                          </p>
                        </div>
                      </Col>
                    ...
                    <Col className="Join_Section_About_First_Col">
                      ...
                      <div className="Join_Section_About_text">
                        ...
                        <div className="col-md-8">
                          <p className="size_32 line-56">
                            Come join our team and make your mark on Terafort’s
                            brave, curious and strategic work. You’re only one
                            you and baby that’s the fun of you.
                          </p>
                        </div>
                      </div>
                    </Col>
